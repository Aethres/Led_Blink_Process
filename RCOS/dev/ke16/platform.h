/** @file       ke16/platform.h
 *  @brief      Platform specific modifications for NXP KE16
...
/** 
 *  @defgroup   KE16 KE16
 *  @brief      NXP KE16 family cpu devices
 *  @ingroup    PLATFORM
 *  @{
 *      @defgroup   KE16_DEV_IO DEV_IO
 *      @defgroup   KE16_DEV_COM DEV_COM
 *      @defgroup   KE16_DEV_MEM DEV_MEM
 *      @defgroup   KE16_DEV_CPX DEV_CPX
 */
