/** @file       ke14/platform.h
 *  @brief      Platform specific modifications for NXP KE14
...
/** 
 *  @defgroup   KE14 KE14
 *  @brief      NXP KE14 family cpu devices
 *  @ingroup    PLATFORM
 *  @{
 *      @defgroup   KE14_DEV_IO DEV_IO
 *      @defgroup   KE14_DEV_COM DEV_COM
 *      @defgroup   KE14_DEV_MEM DEV_MEM
 *      @defgroup   KE14_DEV_CPX DEV_CPX
 */
