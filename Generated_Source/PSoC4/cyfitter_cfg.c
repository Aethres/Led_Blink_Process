...
void cyfitter_cfg(void)
{
...

	{
		...
		CY_SET_REG32((void *)(CYREG_HSIOM_PORT_SEL5), 0x00300099u);

		/* UDB_PA_0 Starting address: CYDEV_UDB_PA0_BASE */
		CY_SET_REG32((void *)(CYDEV_UDB_PA0_BASE), 0x00990000u);
		CY_SET_REG32((void *)(CYREG_UDB_PA0_CFG8), 0x04000000u);
		...
		CY_SET_REG32((void *)(CYREG_UDB_PA5_CFG8), 0x00450000u);
	...
	CY_SET_REG32((void *)(CYREG_GPIO_PRT0_PC), 0x00000B6Du);
	...
	CY_SET_REG32((void *)(CYREG_GPIO_PRT3_PC), 0x00036D80u);

	/* IOPINS0_4 Starting address: CYDEV_GPIO_PRT4_BASE */
	CY_SET_REG32((void *)(CYDEV_GPIO_PRT4_BASE), 0x00000078u);
	...
	CY_SET_REG32((void *)(CYDEV_GPIO_PRT5_BASE), 0x00000022u);
	CY_SET_REG32((void *)(CYREG_GPIO_PRT5_PC), 0x00030031u);
	...
	CY_SET_REG32((void *)(CYREG_GPIO_PRT7_PC2), 0x00000003u);
